...
| 8. **Full suite** + **live harness smoke** per Validation strategy #6 and #7. — **PARTIAL 2026-08-23: full suite green on the 3.4.2 interpreter (525 passed / 4 skipped); narrow suites green on 4.0.0b3 venv (32 passed). Still pending: full-suite run inside a complete fastmcp-4 env and the live harness smoke (ZCode/opencode reconnect after tool restart).** | All green. | — |

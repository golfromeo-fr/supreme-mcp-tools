...
FEF V3 Integration:
- Management server on port 9010 (separate from oraclemcp_sse on 9000)
- Extensions: query_stats, connection_pool, schema_cache
- Mutators: query_timeout
- Actions: reset_connections, clear_cache
"""
import sys
import os
import logging
...
if MONITORING_AVAILABLE and add_metrics_middleware is not None:
    try:
        ...
        # Using collector_name=TOOL_NAME ensures metrics are labeled with "oraclemcp"
